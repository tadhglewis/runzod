...
const ObjectType = z.object({ name: z.string(), age: z.number(), isActive: z.boolean(), tags: z.array(z.string())});

// Runtypes used to use `t.Record` instead of `t.Object`. We should transform both to zod
// @ts-expect-error
const RuntypesV1Record = z.object({ name: z.string(), age: z.number(), isActive: z.boolean(), tags: z.array(z.string())});
...
const OptionalType = z.object({ name: z.string(), age: z.number().optional()});
